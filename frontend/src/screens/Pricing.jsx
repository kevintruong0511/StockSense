...
const PLANS = [
  {
    ...
    features: [
      ...
      '2 lượt phân tích AI/ngày · model V4 Flash',
      'Phân tích nhanh: research web + khuyến nghị Mua/Bán/Giữ',
  ...
  },
  {
    ...
    features: [
      ...
      'Chọn model: V4 Flash (nhanh) hoặc V4 Pro (sâu hơn)',
      'Phân tích chuyên sâu: định giá + kỹ thuật + dự đoán giá',
  ...
  },
  {
    ...
    features: [
      ...
      'Phân tích AI không giới hạn · model V4 Pro',
      'Chiều sâu tối đa: thêm phân tích ngành + vĩ mô',
...
const COMPARE = [
  ...
  { label: 'Model AI', free: 'V4 Flash', pro: 'V4 Flash / V4 Pro', ultra: 'V4 Flash / V4 Pro' },
  { label: 'Tự chọn model (Flash/Pro)', free: false, pro: true, ultra: true },
  { label: 'Chiều sâu phân tích', free: 'Nhanh, cơ bản', pro: 'Chuyên sâu', ultra: 'Chuyên sâu + ngành & vĩ mô' },
